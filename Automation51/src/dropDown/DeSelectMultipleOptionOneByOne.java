...
public class DeSelectMultipleOptionOneByOne {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		boolean multiple=selcon.isMultiple();
		if(multiple) {
			...
			Thread.sleep(3000);
			selcon.deselectByIndex(0);
			Thread.sleep(3000);
			selcon.deselectByValue("India");
			Thread.sleep(3000);
			selcon.deselectByVisibleText("China");
			Thread.sleep(3000);
		}
